...
console.log(
  'Draft variations: deferred attachment, persisted selection, branch/revision guards, incremental saves and finish cleanup, gallery ownership and safe discard passed',
);
