...
settings.galleryVideoPrompts = {
  presets: [
    { ...defaultMediaPrompt('video'), id: 'gallery-local', name: 'Cinematic', operation: 'video' },
  ],
...
try {
  ...
  console.log(
    'Settings transfers: isolated prompt stores, name remapping, unchanged missing references, atomic entity imports, read-only copies, avatar PNGs and credential preservation passed',
  );
} finally {
