...
- Capture prompts, input associations and workflows per job/recipe. Chat preparation preserves the complete chat prefix; image editing uses standalone preparation. Selecting a variation changes only the preview, never the working editor. Save attaches results atomically; closing started drafts leaves work running.
